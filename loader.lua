...
--  🎨 EXACTAMENTE IGUAL A YOUNG0X | CHIQUITO & BIEN HECHO
--  ❌ SIN Fast Glitch | 🏋️ Public Training arriba
--  🔄 Auto Rebirths | 🎯 Killing | 🐾 Free Pet Shop | ❌ ✕ SALIR
-- ==================================================
...
-- 🔳 VENTANA — TAMAÑO COMPACTO Y BIEN PROPORCIONADA
...
-- 🏷️ TÍTULO — IGUAL A YOUNG0X
local TitleTop = Instance.new("TextLabel")
TitleTop.Parent = MainFrame
TitleTop.BackgroundTransparency = 1
TitleTop.Position = UDim2.new(0.5, -110, 0, 10)
TitleTop.Size = UDim2.new(0, 220, 0, 30)
...
SubTitle.Position = UDim2.new(0.5, -85, 0, 38)
...
Line.Position = UDim2.new(0.03, 0, 0, 58)
...
-- 📦 FUNCIÓN BOTÓN ABRIR — ESTILO YOUNG0X
...
PublicTrain.Position = UDim2.new(0.03, 0, 0, 70)
...
PTIcon.Size = UDim2.new(0, 45, 0, 45)
...
BtnAbrir(PublicTrain, 0.80, 0.15, 85, 50, "PublicTraining")
...
AutoRebirths.Position = UDim2.new(0.03, 0, 0, 155)
...
ARIcon.Size = UDim2.new(0, 40, 0, 40)
...
BtnAbrir(AutoRebirths, 0.72, 0.15, 70, 50, "AutoRebirths")
...
Killing.Position = UDim2.new(0.52, 0, 0, 155)
...
KIcon.Size = UDim2.new(0, 40, 0, 40)
...
BtnAbrir(Killing, 0.72, 0.15, 70, 50, "Killing")
...
FreePetShop.Position = UDim2.new(0.03, 0, 0, 250)
...
PSIcon.Size = UDim2.new(0, 40, 0, 40)
...
print("🎨 IGUAL A YOUNG0X | CHIQUITO & BIEN HECHO")
